...
load('snow.mat');
load('snow_C_matrix_after_DCnQuntize.mat');%用于比较
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%经过处理得到原图像%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
C_matrix_iQuantize=zeros(128,160);
P_matrix=zeros(128,160);
%反量化
for i_x=1:H
    for i_y=1:W
...
for i_x=1:128
    for i_y=1:160
        MSE=MSE+(double(P_matrix(i_x,i_y))-double(snow(i_x,i_y)))^2;
    end
end
MSE=MSE/128/160;
